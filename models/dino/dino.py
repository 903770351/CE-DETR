...
class DINO(nn.Module):
    ...
    def forward(self, samples: NestedTensor, targets: List=None, is_recover=False):
...
def build_dino(args):
    ...
    weight_dict['loss_recover'] = args.recover_loss_coef
